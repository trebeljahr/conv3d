...
description: From nothing to your first converted model in three minutes.
---
...
See [Using conv3d from scripts & agents](./agents) for the full contract.

## Next

- [Commands reference](./commands) — every flag for every command.
- [Output layout](./output) — how to control where files land.
- [FBX texture recovery](./textures) — what those `✨ Recovered N external texture(s)` lines mean.
